...
from sentiment_analysis_albert.utils import load_csv,shuffle_one
...
def read_csv(input_file):
    ...
    lines2 = [ [list(dict_label.keys())[list(dict_label.values()).index( l[0])], l[1]] for l in lines  if type(l[1])==str]
...
def read_csv_test(input_file):
    ...
    lines2 = [ [list(dict_label.keys())[list(dict_label.values()).index( l[0])], l[1]] for l in lines  if type(l[1])==str]
    lines3 = shuffle_one(lines2)
    print('Read csv test finished!(1)')
    return lines3
